 ...
 * - 단일 넛지 + contributors 2개 이상: "A·B 접근성이 뛰어나 {넛지} 관점에서 N위에 올랐습니다."
 * - 단일 기여 요소: "A이(가) 돋보여 {넛지} N위에 올랐습니다."
 * - 복수 넛지: "A·B이(가) 균형 있게 우수해 선정된 넛지 종합 N위입니다."
 * - fallback: "{넛지} 종합 평가에서 N위에 선정됐습니다."
 */
