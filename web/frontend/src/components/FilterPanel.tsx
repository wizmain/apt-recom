...
export default function FilterPanel({ isOpen, onClose, filters, onApply, onClear, resultCount }: FilterPanelProps) {
      ...
      >
        <div className="bg-white border-b border-gray-200 shadow-lg">
          ...
          <div className="px-4 py-3 max-h-[60dvh] sm:max-h-[380px] overflow-y-auto space-y-4">
            ...
            <FilterSection title="최고층">
              <ChipGroup
                ...
                onChange={(idx) => {
                  setLocal(p => ({ ...p, minFloor: FLOOR_OPTIONS[idx].value }));
                }}
              />
            </FilterSection>
          ...
          <div className="flex gap-2 px-4 py-2.5 border-t border-gray-100">
            <button onClick={() => { onClear(); setLocal({}); }}
